...
@:forward(is_defined,fold)abstract Report<E>(Option<Err<E>>) from Option<Err<E>>{
  ...
  @:from static public function fromStdOption<E>(opt:StdOption<Err<E>>):Report<E>{
  ...
  public function merge(that:Report<E>):Report<E>{
    return Option._()._.merge((l:Err<E>,r) -> l.next(r),that.prj(),this);
  }
