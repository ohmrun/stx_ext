...
class Destructure extends Clazz{
  ...
  /**
	...
	**/
  public function starts_with(frag: Chars,self: Chars): Bool {
  ...
  /**
	...
	**/
  public function ends_with(frag: Chars,self: Chars): Bool {
  ...
  /**
	...
	**/
  public function contains(substr: Chars, self: Chars): Bool {
    return self.indexOf(substr) != -1;
  }
  /**
		Returns a Chars where sub is replaced by by in s.
	**/
  public function replace(sub : Chars, by : Chars, self : Chars ) : Chars {
    return StringTools.replace(self, sub, by);
  }
  /**
		Surrounds `v`, prepending `l` and concating `r`.
	**/
  public function brackets(l:Chars,r:Chars,self:Chars){
    return '$l$self$r';
  }
  /**
		prepend `before` on `str.`
	**/
  public function prepend(before:Chars,self:Chars){
    return before + self;
  }
  /**
		concat `before` on `str.`
	**/
  public function append(after:Chars,self:Chars){
    return self + after;
  }
  /**
		Get character code from `str` at index `i`.
	**/
  public function cca(i:Int,self:Chars){
    return self.charCodeAt(i);
  }
  public function at(i:Int,self:Chars):Chars{
    return self.charAt(i);
  }
  /**
		Returns an Array of `str` divided into sections of length `len`.
	**/
  public function chunk(len: Int = 1,self: Chars): Array<Chars> {
    var start = 0;
  ...
  /**
		Split `st` at `sep`.
	**/
  public function split(sep:Chars,self:Chars):Array<Chars>{
  ...
  /**
	...
	**/
  public function replace_recurse( sub : Chars, by : Chars, self : Chars ) : Chars {
    if(sub.length == 0)
  ...
  public function is_space(pos : Int, self : Chars ) : Bool {
   ...
   **/
  public function after(sub: Chars,self: Chars): Chars {
   ...
   * if sub does not occur in a, empty string.
   **/
  public function before(sub: Chars,self: Chars): Chars {
